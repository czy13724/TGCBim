...
const dict = {
    ...
    admin_addadmin_usage: { en: 'Usage: /addadmin <uid>', zh: '用法：/addadmin <uid>' },
    admin_removeadmin_usage: { en: 'Usage: /removeadmin <uid>', zh: '用法：/removeadmin <uid>' },
    admin_addadmin_owner_only: { en: 'Only owner can manage admins.', zh: '只有所有者可以管理管理员。' },
    admin_addadmin_exists: { en: 'Admin already exists: {UID}', zh: '管理员已存在：{UID}' },
    admin_addadmin_done: { en: 'Added admin: {UID}', zh: '已添加管理员：{UID}' },
    admin_removeadmin_not_found: { en: 'Admin not found: {UID}', zh: '管理员不存在：{UID}' },
    admin_removeadmin_done: { en: 'Removed admin: {UID}', zh: '已移除管理员：{UID}' },
    ...
    admin_broadcast_mode_reply: { en: 'Reply message', zh: '回复消息' },
    admin_broadcast_confirm_btn: { en: 'Confirm Send', zh: '确认发送' },
    admin_broadcast_cancel_btn: { en: 'Cancel', zh: '取消' },
